...
export const DUNGEONS: Dungeon[] = [
  // 1. FLORESTA ETERNA
  {
    ...
    rewards: {
      ...
      completionRewards: {
        coronas: 1000,
        experience: 250, // Dungeon mais fácil - 5 andares com múltiplas batalhas difíceis
      },
    },
  },
  ...
  // 2. CAVERNA DAS PROFUNDEZAS
  {
    ...
    rewards: {
      ...
      completionRewards: {
        coronas: 1500,
        experience: 400, // Dungeon intermediária - batalhas mais desafiadoras
      },
    },
  },
  ...
  // 3. RUÍNAS ANTIGAS
  {
    ...
    rewards: {
      ...
      completionRewards: {
        coronas: 2000,
        experience: 600, // Dungeon avançada - batalhas significativamente mais difíceis
      },
    },
  },
  ...
  // 4. VULCÃO FURIOSO
  {
    ...
    rewards: {
      ...
      completionRewards: {
        coronas: 3000,
        experience: 1000, // Dungeon difícil - batalhas extremamente desafiadoras
      },
    },
  },
  ...
  // 5. ABISMO ETERNO
  {
    ...
    rewards: {
      ...
      completionRewards: {
        coronas: 5000,
        experience: 2000, // Dungeon final - o maior desafio do jogo, recompensa massiva
      },
    },
  },
];
