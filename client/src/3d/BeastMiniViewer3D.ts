...
export class BeastMiniViewer3D {
  ...
  constructor(container: HTMLElement, beast: Beast, width: number = 120, height: number = 120) {
    ...
    this.camera.position.set(2.5, 0.7, 3);
    this.camera.lookAt(0, -0.3, 0);
    console.log('[MiniViewer3D] Camera positioned at (2.5, 0.7, 3) looking at (0, -0.3, 0)');
  ...
  private loadBeastModel(beast: Beast) {
    ...
    try {
      ...
      // Adjust Y position to center vertically in viewport
      this.beastModel.position.y = -0.4;
