...
export class ImmersiveBattleScene3D {
  ...
  private createBackgroundTrees() {
    ...
    const treePositions: Array<[number, number, number]> = [
      // Anel interno (próximo da arena) - mais denso
      [-18, 0, -14], [-14, 0, -18], [-16, 0, -16], [-17, 0, -15], [-15, 0, -17],
      [18, 0, -14], [14, 0, -18], [16, 0, -16], [17, 0, -15], [15, 0, -17],
      [-18, 0, 14], [-14, 0, 18], [-16, 0, 16], [-17, 0, 15], [-15, 0, 17],
      [18, 0, 14], [14, 0, 18], [16, 0, 16], [17, 0, 15], [15, 0, 17],
      
      // Anel médio - mais denso
      [-22, 0, -10], [-10, 0, -22], [-20, 0, -20], [-21, 0, -12], [-12, 0, -21], [-19, 0, -19],
      [22, 0, -10], [10, 0, -22], [20, 0, -20], [21, 0, -12], [12, 0, -21], [19, 0, -19],
      [-22, 0, 10], [-10, 0, 22], [-20, 0, 20], [-21, 0, 12], [-12, 0, 21], [-19, 0, 19],
      [22, 0, 10], [10, 0, 22], [20, 0, 20], [21, 0, 12], [12, 0, 21], [19, 0, 19],
      
      // Anel externo (fundo) - mais denso
      [-26, 0, -6], [-6, 0, -26], [-24, 0, -24], [-25, 0, -8], [-8, 0, -25], [-23, 0, -23], [-27, 0, -4], [-4, 0, -27],
      [26, 0, -6], [6, 0, -26], [24, 0, -24], [25, 0, -8], [8, 0, -25], [23, 0, -23], [27, 0, -4], [4, 0, -27],
      [-26, 0, 6], [-6, 0, 26], [-24, 0, 24], [-25, 0, 8], [-8, 0, 25], [-23, 0, 23], [-27, 0, 4], [-4, 0, 27],
      [26, 0, 6], [6, 0, 26], [24, 0, 24], [25, 0, 8], [8, 0, 25], [23, 0, 23], [27, 0, 4], [4, 0, 27],
      
      // Árvores laterais (esquerda e direita) - mais densas
      [-28, 0, 0], [-30, 0, -8], [-30, 0, 8], [-29, 0, -4], [-29, 0, 4], [-31, 0, -12], [-31, 0, 12], [-32, 0, -6], [-32, 0, 6],
      [28, 0, 0], [30, 0, -8], [30, 0, 8], [29, 0, -4], [29, 0, 4], [31, 0, -12], [31, 0, 12], [32, 0, -6], [32, 0, 6],
      
      // Árvores frontais e traseiras - mais densas
      [0, 0, -28], [-8, 0, -30], [8, 0, -30], [-4, 0, -29], [4, 0, -29], [-12, 0, -31], [12, 0, -31], [-6, 0, -32], [6, 0, -32],
      [0, 0, 28], [-8, 0, 30], [8, 0, 30], [-4, 0, 29], [4, 0, 29], [-12, 0, 31], [12, 0, 31], [-6, 0, 32], [6, 0, 32],
      
      // Anel muito externo (fundo distante) - para criar profundidade
      [-34, 0, -2], [-2, 0, -34], [-33, 0, -10], [-10, 0, -33], [-35, 0, 2], [-2, 0, 35], [-33, 0, 10], [-10, 0, 33],
      [34, 0, -2], [2, 0, -34], [33, 0, -10], [10, 0, -33], [35, 0, 2], [2, 0, 35], [33, 0, 10], [10, 0, 33],
      [-36, 0, -14], [-14, 0, -36], [-36, 0, 14], [-14, 0, 36],
      [36, 0, -14], [14, 0, -36], [36, 0, 14], [14, 0, 36],
    ];
